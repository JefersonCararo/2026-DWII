...
{
    $stmt = $pdo->prepare(
        "INSERT INTO logs (tabela_afetada, registro_id, acao, usuario_login, detalhes) VALUES ('projetos', :id, :acao, :usuario, :detalhes)"
    );
    $stmt->execute([
        ':id' => $registro_id,
        ':acao' => $acao,
    ...
    <main>
        <div class="container">
            ...
            <div style="display:flex; gap:12px; margin-top:8px;">
                ...
                <?php if ($em_edicao): ?>   
                    <a href="admin.php" class="btn-secundario">Cancelar edição</a>
                <?php endif; ?>
            </div>  
        </form>
