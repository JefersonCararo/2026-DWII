...
$stmt = $pdo->query(
    "SELECT * FROM tecnologias WHERE status = 'ativo' ORDER BY nome ASC"); 
...
<h1 class="titulo-secao" style="margin: 0;"> CATALOGO DE TECNOLOGIAS</h1>
